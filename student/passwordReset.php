  ...
  <body>
    ...
    <?php
      ...
      if(isset($_POST['reset'])) {
        ...
        $sql1 = "SELECT username FROM `student`"; //returns usernames already signed up
        $sql2 = "SELECT email FROM `student`"; //returns emails already signed up
        ...
        if($reset1 === true && $reset2 === true) { //if username and email match in the system
            mysqli_query($db, "UPDATE student SET password='$_POST[Password]'

...
<html lang="en" dir="ltr">
  ...
  <div class ="editButton" style="float: right; margin-top: 5%">
    <form class="editProfile" method="post">
      ...
      <input type="text" name="sID2" placeholder="Student ID" required=""> <br><br>
  ...
  <?php
    if(isset($_POST['edit1'])) { //checks to see if button is pressed
      $taken = false;
      $sql2 = "SELECT username FROM `student`"; //returns usernames already signed up
      ...
      //generated code from phpmystudent
      if(!$taken){
        mysqli_query($db,"UPDATE `student` SET `s_id` = '$_POST[sID2]',`firstName` = '$_POST[firstname2]',
